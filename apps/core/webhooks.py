...
def sova_webhook(request):
    ...
    # ✅ VIKTIGT: overall_score hämtas BARA från API:t, inte från webhook!
    # Detta körs bara om du vill hämta overall_score från SOVA API:t
    if normalized == "completed" and invitation.sova_project_id and invitation.request_id:
        try:
            ...
            if match:
                # Detta är ett NUMERISKT värde från API:t
