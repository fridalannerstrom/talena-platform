#!/usr/bin/env python3
'''
Connect the complete process-context feature to Django i18n.
...
Run from the repository root:
    ...
    python apply_process_context_i18n.py --check
    python apply_process_context_i18n.py --apply
'''
...
def replace_once(
    ...
    *,
    ...
    if count != 1:
        raise RuntimeError(
            f"{description}: expected exactly one occurrence, "
            f"found {count}.\n\nSearch text:\n{old[:900]}"
        )
